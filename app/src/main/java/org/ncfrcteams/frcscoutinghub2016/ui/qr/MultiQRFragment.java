package org.ncfrcteams.frcscoutinghub2016.ui.qr;
...
public class MultiQRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_multi_qr, container, false);

        mViewPager = (ViewPager) root.findViewById(R.id.container);
        Log.e("ViewPager",(mViewPager == null) ? "null" : "not null");
        mViewPager.setAdapter(mQRFragmentAdapter);
