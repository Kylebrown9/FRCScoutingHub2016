...
public class ConfirmDialog {
    private static final String POSITIVE_TEXT = "Ya";
    private static final String NEUTRAL_TEXT = "Eh";
    private static final String NEGATIVE_TEXT = "Nah";
     ...
     */
    public ConfirmDialog(Context context, ConfirmationListener cL, String title, String prompt, String identifier, boolean hasNeutral) {
        ...
        if(hasNeutral) {
            ...
            alert.setNegativeButton(NEUTRAL_TEXT, neutralListener);
        }
    ...
    /**
     * Represents an object which can accept confirmation from a ConfirmDialog
     */
